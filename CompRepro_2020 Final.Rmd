...
One of the important thinks Wilson et. al suggest is to amend data management best practices. All raw data should be saved, it should be backed up more than once, it should be analysis friendly, all steps should be annotated, unique identifiers should be anticipated, and all data should be submitted to a reputable DOI-issuing repository so others can access and cite. R can be used for this by linking all code to a repository like GIT and allowing for frequent use of comments to describe what the code is used for
